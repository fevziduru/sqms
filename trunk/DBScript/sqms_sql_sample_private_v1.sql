...
CREATE TABLE RESPERMISSION  (
   ...
   CONSTRAINT PK_RESPERMISSION PRIMARY KEY (RESID, OPID, ROLEID, ORGANIZATIONID)
);
...
/*==============================================================*/
CREATE INDEX PERMRESOURCE_PK ON RESPERMISSION (
   RESID ASC
);
...
CREATE TABLE ROLEPERMISSION  (
   ...
   ORGANIZATIONID       VARCHAR2(40)                    NOT NULL,
   PERMISSIONID         VARCHAR2(40)                    NOT NULL,
   CONSTRAINT PK_ROLEPERMISSION PRIMARY KEY (ROLEID, ORGANIZATIONID, PERMISSIONID)
);
...
COMMENT ON COLUMN ROLEPERMISSION.ORGANIZATIONID IS
'ORGANIZATIONID';
...
CREATE TABLE USERROLE  (
   ...
   PASSPORTID           VARCHAR2(40)                    NOT NULL,
   ORGANIZATIONID       VARCHAR2(40)                    NOT NULL,
   CONSTRAINT PK_USERROLE PRIMARY KEY (ROLEID, PASSPORTID, ORGANIZATIONID)
);
