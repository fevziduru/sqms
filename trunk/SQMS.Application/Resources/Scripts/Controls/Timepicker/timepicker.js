	...
	*/
	$.fn.timepicker = function(options)
	{
        ...
        _clearWrapClass = 'clear-wrap',
		    _clearText = '清除', // Display text for clear link
        _closeWrapClass = 'close-wrap',
		    _closeText = '确定', // Display text for close link
        _suggestTimeNames = {
		...
		var _html = '<div id="' + _mainWrap + '" class="' + _mainClass
              ...
              + '"><td class="grey" colspan="5">当前时间</td></tr><tr class="' + _timeSuggestWrapClass
              + '"><td colspan="5">06:00</td></tr><tr class="' + _timeSuggestWrapClass
              + '"><td class="grey" colspan="5">12:00</td></tr><tr class="' + _timeSuggestWrapClass
              + '"><td colspan="5">18:00</td></tr><tr class="' + _timeSuggestWrapClass
              + '"><td class="grey" colspan="5">00:00</td></tr><tr class="' + _buttonWrapClass
		...
		*/
		...
		function setPosition(input)
		{
			...
			if ($.browser.opera)
			{ // correction for Opera when scrolled
