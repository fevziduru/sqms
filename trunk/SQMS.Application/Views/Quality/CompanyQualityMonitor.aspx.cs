...
namespace SQMS.Application.Views.Quality
{
        public partial class CompanyQualityMonitor : SQMSPage<QualityControlService>
        {
                ...
                {
                        this.svcQualityControl = ServiceManager.CreateService<QualityControlService>();
                        this.svcProject = ServiceManager.CreateService<ProjectService>();
                        this.svcEmployee = ServiceManager.CreateService<EmployeeService>();
                        this.svcRoad = ServiceManager.CreateService<RoadService>();
                }
