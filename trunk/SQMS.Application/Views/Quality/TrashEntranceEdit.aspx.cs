...
{
        public partial class TrashEntranceEdit : SQMSPage<EmergencyEventService>
        {
               protected void Page_Load(object sender, EventArgs e)
                ...
                protected override void GetViewData()
                {
                        ...
                        if (drEE != null)
                        {
                                ...
                                drEE["CHECKTIME"] = this.checkTime.Text; //Request.Form["tbSTIME"];
                ...
                public void btnSave_Click(object sender, EventArgs e)
                {
                        ...
                        Response.Redirect(String.Format("TrashEntranceView.aspx?p=emergencyview&id={0}", this.ID));
                }
                ...
                public void btnSaveAndNew_Click(object sender, EventArgs e)
                {
                        ...
                        Response.Redirect("TrashEntranceEdit.aspx?p=emergencynew");
                }
        }
