...
{
        public partial class TrashEntranceView : SQMSPage<EmergencyEventService>
        {
        ...
        public void btnDelete_OnClick(object sender, EventArgs e)
        {
            ...
            Response.Redirect("TrashEntranceList.aspx?p=emergencylist");
        }

        public void btnEdit_OnClick(object sender, EventArgs e)
        {
            Response.Redirect("TrashEntranceEdit.aspx?p=emergencyedit&id=" + this.ID);
        }
