...
namespace SQMS.Application.Views.Vehicle
{
    public partial class VehicleMonitor : SQMSPage<VehicleMissionService>
    {
        ...
        protected bool EnableResPointList
        {
            get
            {
                return this.Request.QueryString["respointlist"].ParesBool();
            }
        }
        ...
        {
            if (this.EnableResPointList)
            {
                this.BindResPointList();
            }
            else
            {
        ...
        protected void BindResPointList()
        {
            DataTable dt = this.svcQualityControl.GetMonitorPointList(MonitorPointType.Resource);
            this.GridViewRes.DataSource = dt;
            this.GridViewRes.DataBind();
        }
        protected void LinkBtnMPName_Command(object sender, CommandEventArgs e)
        {
        ...
        protected void GridViewRes_RowDataBound(object sender, GridViewRowEventArgs e)
        {
