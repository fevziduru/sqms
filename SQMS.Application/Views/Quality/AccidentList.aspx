<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Main.Master" AutoEventWireup="true" CodeBehind="AccidentList.aspx.cs" Inherits="SQMS.Application.Views.Quality.AccidentList" %>
...
<div>
    ...
    <asp:GridView ID="gvEEList" runat="server" AllowPaging="True"  Width="100%" CssClass="gridview"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="EVENTID" HeaderText="事故编号" ReadOnly="True" HeaderStyle-HorizontalAlign="Left"
            ...
            <asp:HyperLinkField DataNavigateUrlFields="EVENTID" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left"
                DataNavigateUrlFormatString="/Views/Quality/AccidentView.aspx?p=emergencyview&id={0}" 
                DataTextField="EVENTNAME" HeaderText="事故名称" SortExpression="EVENTNAME" />
